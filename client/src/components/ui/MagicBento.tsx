...
const MagicBento: React.FC<MagicBentoProps> = ({
  ...
  const bentoData: BentoCardData[] = cards || [
    { title: "Liked Songs", description: "Your favorite tracks in one place", label: "Collection" },
    { title: "Recently Played", description: "Jump right back into music", label: "History" },
    { title: "Top Playlists", description: "Curated for your daily mood", label: "Playlists" },
  ];
    ...
    <>
      ...
      <BentoCardGrid gridRef={gridRef}>
        {bentoData.map((card, index) => {
          const baseClassName = `magic-bento-card cursor-pointer ${textAutoHide ? "magic-bento-card--text-autohide" : ""} ${
