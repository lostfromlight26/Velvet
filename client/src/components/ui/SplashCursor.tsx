...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    const gl: any = context.gl;
    const ext: any = context.ext;
    ...
    function getWebGLContext(cnv: HTMLCanvasElement) {
      const params = {
        alpha: true,
        depth: false,
        stencil: false,
      ...
      let webgl = cnv.getContext("webgl2", params) as any;
      const isWebGL2 = !!webgl;
      if (!webgl) {
        webgl = (cnv.getContext("webgl", params) ||
          cnv.getContext("experimental-webgl", params)) as any;
      }
    ...
    function getSupportedFormat(targetGl: any, internalFormat: any, format: any, type: any): any {
    ...
    function supportRenderTextureFormat(targetGl: any, internalFormat: any, format: any, type: any) {
